...
from monai.data import load_decathlon_datalist, WSIReader
...
def get_loader(args):
    ...
    train_transform = transforms.Compose(
        [
            transforms.LoadImaged(keys=["image", "label"], reader=WSIReader,backend="cucim", image_only=True),
            transforms.AddChanneld(keys=["image", "label"]),
            transforms.ScaleIntensityRanged(
                keys=["image"], a_min=0.0, a_max=255.0, b_min=args.b_min, b_max=args.b_max, clip=True
            ),
